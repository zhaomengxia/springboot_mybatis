package com.springsecurityjwt.springsecurityjwt.util;
...
public class JwtUtils {
     ...
     * jwt 加密解密密钥
     */
    private static final String JWT_SECRET = "zhaomengxiaceshitoken" + "*jdk&gJw%tE#ncry^pt";
