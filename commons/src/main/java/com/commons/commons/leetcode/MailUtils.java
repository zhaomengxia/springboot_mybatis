...
public class MailUtils {
	...
	protected static final String DEFAULT_MAIL_PORT ="465";//默认端口号
    ...
    public interface MailMessage{
    	...
    	public MimeMessage getMimeMessage(Session session, String from) throws MessagingException, UnsupportedEncodingException, javax.mail.MessagingException;
    }
    /**
